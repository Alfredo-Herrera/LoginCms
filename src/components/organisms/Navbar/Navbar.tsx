    ...
    return (
        <div className="flex flex-wrap">
            <section className="relative mx-auto">
                <nav className="flex justify-between bg-color5 text-white w-screen">
                ...
                {open && (
                    <div className="absolute right-0 w-full max-w-screen-sm mt-2 bg-color5 text-white rounded-md shadow-lg z-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {navbarData.map((item, index) => (
                                <Link
                                    ...
                                    legacyBehavior
                                >
                                    <a className="flex items-start p-2 rounded-lg hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
